...
if __name__ == "__main__":
    ...
    parser.add_argument("--filter-time", type=float, default=2.979)
    parser.add_argument("--sort-time", type=float, default=54.691)
    parser.add_argument("--verify-time", type=float, default=9.408)
    parser.add_argument("--finalize-time", type=float, default=0.566)
    ...
    if args.export_pdf:
        workflow.export_pydot(filename="terasort_sintetico_pycompss_workflowbuilder.pdf")
