...
if __name__ == "__main__":
    ...
    parser.add_argument("--wordcount-time", type=float, default=181.92)
    parser.add_argument("--reduce-time", type=float, default=15.95)
    parser.add_argument("--merge-time", type=float, default=836.46)
    ...
    if args.export_pdf:
        workflow.export_pydot(filename="wordcount_sintetico_pycompss_workflowbuilder.pdf")
