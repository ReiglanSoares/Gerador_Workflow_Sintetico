...
if __name__ == "__main__":
    ...
    parser.add_argument("--init-time", type=float, default=5.12)
    parser.add_argument("--fragment-time", type=float, default=54.82)
    parser.add_argument("--reduce-time", type=float, default=0.29)
    parser.add_argument("--finalize-time", type=float, default=0.05)
    ...
    try:
        ...
        if args.export_pdf:
            workflow.export_pydot(filename="kmeans_sintetico_workflowbuilder.pdf")
